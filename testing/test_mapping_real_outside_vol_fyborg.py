...
TEST THE MAPPING
 ...
 - test the scalar mapping of Fyborg using real data (ADC volume + cropped streamline.trk) but where
...
'''
  ...
  mappedTrkFile = '/chb/tmp/test-202122-fyborg.trk'
  ...
  t.fyborg.fyborg( trkFile, mappedTrkFile, [t.fyborg.FyMapAction( 'test', volFile )], 'debug' ) # run in test mode with debug enabled
